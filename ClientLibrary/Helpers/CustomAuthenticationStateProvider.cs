...
public class CustomAuthenticationStateProvider(LocalStorageService localStorageService) : AuthenticationStateProvider
{
    ...
    private static CustomUserClaims DecryptToken(string jwtToken)
    {
        ...
        var roles = token.Claims.FirstOrDefault(_ => _.Type == ClaimTypes.Role);
        return new CustomUserClaims(userId!.Value, name!.Value, email!.Value, roles!.Value);
    }
    ...
    public async Task UpdateAuthenticationState(UserSession userSession)
    {
        ...
        {
            var serialization = Serializations.SerializeObj(userSession);
            await localStorageService.SetToken(serialization);
